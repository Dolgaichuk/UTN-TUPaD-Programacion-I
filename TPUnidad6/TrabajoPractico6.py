...
#4. Crear dos funciones: calcular_area_circulo(radio) que reciba el ra￾dio como parámetro y devuelva el área del círculo. calcular_peri￾metro_circulo(radio) 
#  que reciba el radio como parámetro y devuel￾va el perímetro del círculo. Solicitar el radio al usuario y llamar am￾bas funciones para mostrar los resultados.
...
# mostrar el resultado .2f indica dos decimales en formato float
...
# llama a la función para convertir a Fahrenheit
